...
def scrape():
    ...
    url_feature_image = "https://https://galaxyfacts-mars.com/"
    ...
    mars_collection["featured_image_url"] = "https://galaxyfacts-mars.com/" + pic_source[2]      
    ...
    url_valles = ('https://marshemispheres.com/')
